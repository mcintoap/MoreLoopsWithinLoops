...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 27
    answer = largest_number(([27], [1,2,5], [21]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 2:
    expected = -1111111111111111
    answer = largest_negative_number(([], [-1111111111111111], [-11]))
    print('Expected and actual are:', expected, answer)

    # Test 3:
    expected = -1
    answer = largest_negative_number(([1], [-5], [2]))
    print('Expected and actual are:', expected, answer)
...
def largest_negative_number(seq_seq):
    ...
    for j in range(len(seq_seq)):
        ...
        for k in range(len(sublist)):
            if sublist[k] < min_number:
                min_number = sublist[k]
    if min_number == 0:
        return None
    return min_number
